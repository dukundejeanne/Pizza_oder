...
function Pizza_Order(size, tiza, number, favo, local, total) {
    this.sizePizza = size;
    this.typePizza = tiza;
...
Pizza_Order.prototype.fullOrder = function () {
    return this.sizePizza + " " + this.typePizza + " " + this.numberPizza + " " + this.favoritePizza + " " + this.toppingPizza ;
}
    ...
    $(document).ready(function () {
        $("form#new-pizz").submit(function (event) {
            ...
            $(".new-pizza").each(function () {
                ...
                var newPiz = new Pizza_Orders(inputtedSizePizza, inputtedTypePizza, inputtedNumberPizza, inputtedFavoritePizza, inputtedToppingPizza);
                newPizza_Order.orders.push(newPiz);
                console.log(newPiz);
            });
        ...
        $(".btn").click(function () {
            ...
            switch (size) {
                ...
                case size = "Large":
                    switch (type) {
                        case type = "Italian pizza 20$":
                            if (crust == "Thin Crust $5") {
                                total = price * number + 50;
                                console.log(total);
                            } else if (crust == "Thick Crust $6") {
                                total = price * number + 40;
                            } else if (crust == "FatBread Crust $7") {
                                total = price * number + 30;
                            }  else if(crust == "FatBread Crust $3") {
                                total = price * number + 100;
                            }else {
                                total = price * number + 20;
                            }
                            break;
                        case type = "Vegetable pizza 30$":
                            if (crust == "Thin Crust $5") {
                                total = price * number + 100;
                            } else if (crust == "Thick Crust $6") {
                                total = price * number + 100;
                        ...
                        case type = "Regima pizza 60$":
                            ...
                            break;
                        case type = " Chicken Tikka pizza 40$":
                            if (crust == "Thin Crust $5") {
                                total = price * number + 100;
                            } else if (crust == "Thick Crust $6") {
                                total = price * number + 110;
